...
<div class="container">
                ...
                <div class="col-sm-2 mt-4">
                    <div class="card border-left-danger">
                        <a href="<?= base_url('dosen'); ?>" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="fw-bold text-danger text-uppercase mb-1">Dosen</div>
                                <div class="h2 mb-0 fw-bold text-gray-800"><?= $jumlah_dosen ?></div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 mt-4">
                    <div class="card border-left-primary">
                        <a href="<?= base_url('penelitian'); ?>" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="fw-bold text-primary text-uppercase mb-1">Penelitian</div>
                                <div class="h2 mb-0 fw-bold text-gray-800"><?= $jumlah_penelitian ?></div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 mt-4">
                    <div class="card border-left-warning">
                        <a href="<?= base_url('pemakalah'); ?>" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="fw-bold text-warning text-uppercase mb-1">Pemakalah</div>
                                <div class="h2 mb-0 fw-bold text-gray-800"><?= $jumlah_pemakalah ?></div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 mt-4">
                    <div class="card border-left-success">
                        <a href="<?= base_url('jurnal'); ?>" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="fw-bold text-success text-uppercase mb-1">Jurnal</div>
                                <div class="h2 mb-0 fw-bold text-gray-800"><?= $jumlah_jurnal ?></div>
                ...
                <div class="col-sm-2 mt-4">
                    <div class="card border-left-ungu">
                        <a href="<?= base_url('hki'); ?>" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="fw-bold text-ungu text-uppercase mb-1">HKI</div>
                                <div class="h2 mb-0 fw-bold text-gray-800"><?= $jumlah_hki ?></div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 mt-4">
                    <div class="card border-left-info">
                        <a href="<?= base_url('buku_ajar'); ?>" style="text-decoration:none;">
                            <div class="card-body">
                                <div class="fw-bold text-info text-uppercase mb-1">Buku Ajar</div>
                                <div class="h2 mb-0 fw-bold text-gray-800"><?= $jumlah_buku_ajar ?></div>
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <script>
        function tampilgrafik() {
            $.ajax({
                type: "post",
                url: "<?= base_url('user/tampilgrafiktingkat') ?>",
                data: {
                    jenis: $('#jenis').val()
                },
                dataType: "json",
