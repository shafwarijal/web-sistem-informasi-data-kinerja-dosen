...
<div class="modal fade hide" id="editAkunadmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-plus"></i> Edit Penelitian</h5>
                <button type="button" class="close" onclick="$('#editAkunadmin').modal('hide');" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('akunadmin/update_data/' . $id_admin, ['class' => 'form-edit']); ?>
            <?= csrf_field(); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" onclick="$('#editAkunadmin').modal('hide');">Cancel</button>
