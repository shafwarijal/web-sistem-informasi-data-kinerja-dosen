        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="tahun_hki" name="tahun_hki" value="<?= $tahun_hki; ?>" autocomplete="off">
                        <!-- <div class="invalid-feedback errorNip">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" onclick="$('#editHki').modal('hide');">Cancel</button>
