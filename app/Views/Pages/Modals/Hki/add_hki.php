    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                ...
                <button type="button" class="close" onclick="$('#addHki').modal('hide');" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nama_hki" name="nama_hki" value="<?php echo session()->get('role') == "2" ? session()->get('nama_user') : '' ?>" <?php echo session()->get('role') == "2" ? 'readonly' : '' ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nidn_hki" name="nidn_hki" value="<?php echo session()->get('role') == "2" ? session()->get('nidn') : '' ?>" readonly>
                ...
                <div class="form-group row">
                    <label for="tahun_hki" class="col-sm-3 col-form-label">Tahun HKI</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="tahun_hki" name="tahun_hki" autocomplete="off" placeholder="Tahun">
                        <!-- <div class="invalid-feedback errorNip">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" onclick="$('#addHki').modal('hide');">Cancel</button>
...
<script>
    ...
    $("#jenis_hki").change(function() {
        if ($(this).val() == "") $(this).addClass("empty");
        else $(this).removeClass("empty")
    });
    $("#jenis_hki").change();

    $("#kd_sts_berkas_hki").change(function() {
        if ($(this).val() == "") $(this).addClass("empty");
        else $(this).removeClass("empty")
    });
    $("#kd_sts_berkas_hki").change();

    $("#status_hki").change(function() {
        if ($(this).val() == "") $(this).addClass("empty");
        else $(this).removeClass("empty")
    });
    $("#status_hki").change();
