        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    ...
                    <button type="button" class="close" onclick="$('#editDosen').modal('hide');" aria-label="Close">
                ...
                <div class="modal-body">
                    ...
                    <div class="<?php echo session()->get('role') == "2" ? 'hidden' : 'show' ?>">
                        <div class="form-group row">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" onclick="$('#editDosen').modal('hide');">Cancel</button>
